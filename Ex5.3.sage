...
hD1D3 = local_ht_at_p + local_hts_away_from_p

# 2) D4 = (T)-(wT), D2 = (R)-(P)
local_ht_at_p = local_height_at_p(T,wT,R,P)
local_hts_away_from_p = -2*Log(2) + Log(3)
hD4D2 = local_ht_at_p + local_hts_away_from_p

# check if zero:
print('------------------------------------------------------------------------------------')
print('h(D1,D3) is '              + str(hD1D3))
print('------------------------------------------------------------------------------------')
print('h(D4,D2) is '              + str(hD4D2))
print('------------------------------------------------------------------------------------')
print('6h(D1,D3) - 4h(D4,D2) is ' + str(6*hD1D3 - 4*hD4D2))
print('------------------------------------------------------------------------------------')
