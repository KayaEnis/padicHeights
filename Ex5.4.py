...
def Int01(i,z1,z2): # integral of omega_i from z1 to z2
    ...
    div2 = [(1,R),(-1,S)]
    Ctilde.init_height(div1,div2)
    third_kind_part = d0[i]/pole[1]*Ctilde.omega_integral(div1,div2)
...
def Int02(pt,z1,z2): # integral of b/(x-a)*dx/y from z1 to z2. z1 and z2 must be DIFFERENT from pt and w(pt)
    ...
    div2 = [(1,R),(-1,S)]
    Ctilde.init_height(div1,div2)
    third_kind_part_1 = dpt0/pole[1]*Ctilde.omega_integral(div1,div2)
    divpt = [(1,Ctilde(a,btilde0)),(-1,Ctilde(a,-btilde0))]
    Ctilde.init_height(divpt,div2)
    third_kind_part_2 = Ctilde.omega_integral(divpt,div2)
